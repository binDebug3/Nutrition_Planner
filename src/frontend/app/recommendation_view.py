...
class RecommendationView:
    ...
    def render_meal_suggestions(self, meal_markdown: str) -> None:
        ...
        Args:
            meal_markdown: Markdown response body generated by Gemini.
        """
        self._log.info(
            "Rendering meal suggestions",
            extra={"event": "ui.recommendation.meal_suggestions"},
        )

        self._st.markdown("## Meal Suggestions")
        safe_markdown(self._st, "<div class='meal-suggestions'>", unsafe_html=True)
        self._st.markdown(meal_markdown)
        safe_markdown(self._st, "</div>", unsafe_html=True)
